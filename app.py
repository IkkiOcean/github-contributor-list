...
level1_points = st.number_input("Points for Level 1", value=3, min_value=0)
level2_points = st.number_input("Points for Level 2", value=6, min_value=0)
...
st.markdown("---")
st.markdown(
    'Built by [IkkiOcean](https://github.com/IkkiOcean)',
